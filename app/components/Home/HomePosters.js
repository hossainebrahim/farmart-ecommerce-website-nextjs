import { setBackgroundImage } from "../../utils/healper";
        ...
        <div className="flex flex-wrap justify-between">
          <div
            ...
            style={setBackgroundImage(
              "https://demo4.drfuri.com/farmart2/wp-content/uploads/sites/11/2021/05/homepage-new-banner-2.png",
              {
          ...
          <div
            className="md:w-[32%] mb-5 w-full md:py-14 md:px-12 py-10 px-6 rounded-lg"
            style={setBackgroundImage(
              "https://demo4.drfuri.com/farmart2/wp-content/uploads/sites/11/2021/05/homepage-new-banner-3.png",
              {
          ...
          >
            <div className="flex flex-col justify-between h-full">
              <div className="">
                ...
                <h2 className="md:text-2xl sm:text-lg text-base font-bold text-title mt-4">
                  Meat pork
                </h2>
              </div>
          ...
          <div
            className="md:w-[32%] mb-5 w-full md:py-14 md:px-12 py-10 px-6 rounded-lg"
            style={setBackgroundImage(
              "https://demo4.drfuri.com/farmart2/wp-content/uploads/sites/11/2021/05/homepage-new-banner-4.png",
              {
                backgroundPosition: "center center",
